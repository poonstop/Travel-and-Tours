$(document).ready(function(){
    ...
    function addPriceCard(){
        ...
        var priceCardHtml= `
        <div id="priceCard${priceCount}" class="price-card-add rounded bg-secondary p-2 mb-3">
            <div>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="form-floating mb-2"> 
                        <input type="text" class="form-control" id="amount${priceCount}" placeholder="">
            ...
            <div class="row">
                <div class="d-flex justify-content-end">
                    <button id="clearPriceBtn" class="btn btn-danger">Clear</button>
                </div>
            </div>
        </div>
        `;
